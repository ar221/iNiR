            ...
            FocusScope {
                ...
                transitions: [
                    Transition {
                        ...
                        NumberAnimation { properties: "y"; duration: Appearance.animation.elementMove.duration; easing.type: Appearance.animation.elementMove.type; easing.bezierCurve: Appearance.animation.elementMove.bezierCurve }
                        ...
                        NumberAnimation { properties: "scale"; duration: Appearance.animation.elementMove.duration; easing.type: Appearance.animation.elementMove.type; easing.bezierCurve: Appearance.animation.elementMove.bezierCurve }
                    },
                    Transition {
                        from: "visible"
                        enabled: Appearance.animationsEnabled
