 ...
 *
 * Session F: new file. Hosts whichever expandedContent CockpitSurface
 * passes in — re-parents it into contentSlot, provides a 40px header
 * with a back button and a duck-typed title.
 *
 * Transparent background by design: AmbientBackground at z:0 is the
 * visual floor for both cockpit and expanded states. Painting a
 * background here would break the "one surface at two scales" intent.
 */
Item {
    id: root
