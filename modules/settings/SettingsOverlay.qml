...
Scope {
    ...
    property var overlaySearchIndex: [
        ...
        // Themes (page 4)
        { pageIndex: 4, pageName: overlayPages[4].name, section: Translation.tr("Global Style"), label: Translation.tr("Global Style"), description: Translation.tr("Material, Cards, Aurora glass effect, Inir TUI style"), keywords: ["global", "style", "aurora", "inir", "material", "cards", "glass", "tui", "transparency", "blur", "courier"] },
        ...
        { pageIndex: 4, pageName: overlayPages[4].name, section: Translation.tr("Global Style"), label: Translation.tr("Courier"), description: Translation.tr("Dispatch-board grammar with square hardware and opaque surfaces"), keywords: ["courier", "dispatch", "terminal", "command", "amber", "warm", "style"] },
        ...
        { pageIndex: 4, pageName: overlayPages[4].name, section: Translation.tr("Interface Scale"), label: Translation.tr("Interface Scale"), description: Translation.tr("Spacing, rounding, font size and animation speed"), keywords: ["scale", "spacing", "rounding", "font", "size", "animation", "speed", "metrics", "zoom", "interface"] },
        { pageIndex: 4, pageName: overlayPages[4].name, section: Translation.tr("Interface Scale"), label: Translation.tr("Spacing scale"), description: Translation.tr("Global spacing/padding multiplier"), keywords: ["spacing", "padding", "margin", "scale", "gap", "compact", "dense"] },
        { pageIndex: 4, pageName: overlayPages[4].name, section: Translation.tr("Interface Scale"), label: Translation.tr("Rounding scale"), description: Translation.tr("Corner rounding multiplier (0% = sharp corners)"), keywords: ["rounding", "corners", "radius", "sharp", "round", "scale"] },
        { pageIndex: 4, pageName: overlayPages[4].name, section: Translation.tr("Interface Scale"), label: Translation.tr("Font size scale"), description: Translation.tr("Global font size multiplier"), keywords: ["font", "size", "scale", "text", "bigger", "smaller", "zoom"] },
        { pageIndex: 4, pageName: overlayPages[4].name, section: Translation.tr("Interface Scale"), label: Translation.tr("Animation speed"), description: Translation.tr("Animation duration multiplier (higher = slower)"), keywords: ["animation", "speed", "duration", "slow", "fast", "motion", "reduce"] },
