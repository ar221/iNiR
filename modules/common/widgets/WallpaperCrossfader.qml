    ...
    Image {
        ...
        Behavior on opacity {
            NumberAnimation {
                ...
                easing.type: root.easingBezierCurve.length === 6 ? Easing.BezierSpline : root.easingType
                easing.bezierCurve: root.easingBezierCurve.length === 6 ? root.easingBezierCurve : []
            }
        }
