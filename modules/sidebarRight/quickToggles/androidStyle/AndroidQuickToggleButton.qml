...
GroupButton {
    ...
    colBackgroundToggledActive: Appearance.sidebar.colAccentSurfaceActive
    ...
    property color colIcon: toggled ? Appearance.sidebar.colOnAccent : Appearance.sidebar.colTextOnSubCard
