...
Item {
    ...
    // Start the Events reminder timer the first time this widget is instantiated.
    // Using Component.onCompleted defers it from boot to sidebar first-open.
    Component.onCompleted: Events.init()
