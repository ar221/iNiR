...
def generate_zed_config(colors, scss_path, output_path):
    ...
    def build_zed_light_theme():
        ...
        light_theme = {
            "border": hex_with_alpha(outline, "ff"),
            "border.variant": hex_with_alpha(adjust_lightness(surface_low, 1.3), "ff"),
            "border.focused": hex_with_alpha(primary, "ff"),
            "border.selected": hex_with_alpha(adjust_lightness(primary, 1.2), "ff"),
            "border.transparent": "#00000000",
            "border.disabled": hex_with_alpha(adjust_lightness(outline, 0.5), "ff"),
            "elevated_surface.background": hex_with_alpha(adjust_lightness(surface_low, 1.2), "ff"),
            "surface.background": hex_with_alpha(adjust_lightness(surface_low, 1.2), "ff"),
            "background": hex_with_alpha(adjust_lightness(surface, 1.5), "ff"),
            "element.background": hex_with_alpha(adjust_lightness(surface_low, 1.2), "ff"),
            "element.hover": hex_with_alpha(adjust_lightness(surface_std, 1.1), "ff"),
            "element.active": hex_with_alpha(adjust_lightness(surface_high, 1.3), "ff"),
            "element.selected": hex_with_alpha(adjust_lightness(surface_high, 1.3), "ff"),
            "element.disabled": hex_with_alpha(adjust_lightness(surface_low, 1.2), "ff"),
            "drop_target.background": hex_with_alpha(primary, "80"),
            "ghost_element.background": "#00000000",
            "ghost_element.hover": hex_with_alpha(adjust_lightness(surface_std, 1.1), "ff"),
            "ghost_element.active": hex_with_alpha(adjust_lightness(surface_high, 1.3), "ff"),
            "ghost_element.selected": hex_with_alpha(adjust_lightness(surface_high, 1.3), "ff"),
            "ghost_element.disabled": hex_with_alpha(adjust_lightness(surface_low, 1.2), "ff"),
            "text": hex_with_alpha(on_surface, "ff"),
            "text.muted": hex_with_alpha(on_surface_variant, "ff"),
            "text.placeholder": hex_with_alpha(
                adjust_lightness(on_surface_variant, 0.8), "ff"
            ...
            "icon.placeholder": hex_with_alpha(on_surface_variant, "ff"),
            "icon.accent": hex_with_alpha(primary, "ff"),
            "status_bar.background": hex_with_alpha(adjust_lightness(surface, 1.5), "ff"),
            "title_bar.background": hex_with_alpha(adjust_lightness(surface, 1.5), "ff"),
            "title_bar.inactive_background": hex_with_alpha(adjust_lightness(surface_low, 1.2), "ff"),
            ...
            "pane.focused_border": None,
            "scrollbar.thumb.background": hex_with_alpha(on_surface_variant, "4c"),
            "scrollbar.thumb.hover_background": hex_with_alpha(adjust_lightness(surface_high, 1.3), "ff"),
            "scrollbar.thumb.border": hex_with_alpha(adjust_lightness(surface_std, 1.1), "ff"),
            "scrollbar.track.background": "#00000000",
            "scrollbar.track.border": hex_with_alpha(adjust_lightness(surface_std, 1.1), "ff"),
            "editor.foreground": hex_with_alpha(on_surface, "ff"),
            "editor.background": hex_with_alpha(adjust_lightness(surface, 1.5), "ff"),
            "editor.gutter.background": hex_with_alpha(adjust_lightness(surface, 1.5), "ff"),
            "editor.subheader.background": hex_with_alpha(adjust_lightness(surface_low, 1.2), "ff"),
            "editor.active_line.background": hex_with_alpha(adjust_lightness(surface_low, 1.2), "bf"),
            "editor.highlighted_line.background": hex_with_alpha(adjust_lightness(surface_std, 1.1), "ff"),
            "editor.line_number": hex_with_alpha(on_surface_variant, "ff"),
            "editor.active_line_number": hex_with_alpha(on_surface, "ff"),
            "editor.hover_line_number": hex_with_alpha(
                adjust_lightness(on_surface, 1.1), "ff"
            ...
            "version_control.conflict_marker.ours": hex_with_alpha(tertiary, "1a"),
            "version_control.conflict_marker.theirs": hex_with_alpha(primary, "1a"),
            "conflict": hex_with_alpha(adjust_lightness(tertiary, 0.9), "ff"),
            "conflict.background": hex_with_alpha(
                adjust_lightness(tertiary, 0.9), "1a"
            ),
            "conflict.border": hex_with_alpha(adjust_lightness(tertiary, 0.6), "ff"),
            "created": hex_with_alpha(tertiary, "ff"),
            "created.background": hex_with_alpha(tertiary, "1a"),
        ...
        for name, idx in color_map.items():
            base_color = term_colors.get(f"term{idx}", "#ffffff")
            if "bright" in name:
                color = adjust_lightness(base_color, 1.1)
            elif "dim" in name:
                color = adjust_lightness(base_color, 0.9)
            else:
                color = base_color
            light_theme[f"terminal.ansi.{name}"] = hex_with_alpha(color, "ff")

        # Players (same colors as dark theme, no adjustments)
        player_colors = [
            primary,
            error,
            tertiary,
        ...
        # Syntax highlighting (same colors as dark theme, no adjustments)
        light_theme["syntax"] = {
            "attribute": {
                "color": hex_with_alpha(primary, "ff"),
                "font_style": None,
            ...
            "punctuation.bracket": {
                "color": hex_with_alpha(adjust_lightness(on_surface, 1.1), "ff"),
                "font_style": None,
                "font_weight": None,
            },
            "punctuation.delimiter": {
            ...
            "string.escape": {
                "color": hex_with_alpha(
                    adjust_lightness(on_surface_variant, 0.9), "ff"
                ),
                "font_style": None,
                "font_weight": None,
            },
        ...
        light_theme["background"] = adjust_lightness(
            my_colors.get("surface", "#ffffff"), 1.5
        )
        light_theme["surface.background"] = adjust_lightness(
            my_colors.get("surface_container_low", "#f0f0f0"), 1.2
        )
