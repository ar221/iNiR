...
IPC_SHARED_TARGETS=(ai altSwitcher appCatalog audio bar brightness cheatsheet clipboard cliphistService closeConfirm contracts controlPanel courierRail coverflowSelector dashboard dictation focus gamemode globalActions gptProxy lock mediaControls minimize mpris notifications osdVolume osk overview packageSearch panelFamily plugins proxy region session settings shellUpdate tiling voiceSearch wallpaperSelector ytmusic zoom)
