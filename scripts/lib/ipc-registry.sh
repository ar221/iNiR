...
IPC_ALL_TARGETS=(ai altSwitcher appCatalog audio bar brightness cheatsheet clipboard cliphistService closeConfirm contracts controlPanel coverflowSelector dictation focus gamemode globalActions lock mediaControls minimize mpris notifications osd osdVolume osk overlay overview packageSearch panelFamily plugins proxy region search session settings shellUpdate taskview tiling voiceSearch wactionCenter waffleAltSwitcher wallpaperSelector wbar widgets wnotificationCenter wwidgets ytmusic zoom)
IPC_SHARED_TARGETS=(ai altSwitcher appCatalog audio bar brightness cheatsheet clipboard cliphistService closeConfirm contracts controlPanel coverflowSelector dictation focus gamemode globalActions lock mediaControls minimize mpris notifications osdVolume osk overview packageSearch panelFamily plugins proxy region session settings shellUpdate tiling voiceSearch wallpaperSelector widgets ytmusic zoom)
